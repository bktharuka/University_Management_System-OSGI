...
public class LecturerProducerImpl implements LecturerProducer{
	...
	public void UpdateLecturer(Lecturer lecturer) {
		...
		while (input.equalsIgnoreCase("y") || input.equalsIgnoreCase("Y")) {
			...
			System.out.print("Do You Want To Update Another Lecturer(y|Y or n|N)?: ");
			input = sc.next();
		}
...
//	public Lecturer1 getLecturer1ById(String lecturer1Id) {
//		for (Lecturer1 lecture1 : llecturer1) {
//			if (lecture1.getNic() == lNic) {
//				return lecture1;
//			}
//		}
//		
